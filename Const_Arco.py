...
temp_dir = "/tmp"  # Usando o diretório temporário padrão do sistema
...
def processar_constancia_arco(uploaded_excel, uploaded_word):
    ...
    excel_path = os.path.join(temp_dir, "temp_excel.xlsx")
    word_path = os.path.join(temp_dir, "temp_word.docx")
    img_path = os.path.join(temp_dir, "grafico_gerado.png")
    output_word_path = os.path.join(temp_dir, "Documento_Atualizado.docx")
